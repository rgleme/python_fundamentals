...
engine = create_engine("postgresql://dexter:4linux@127.0.0.1/dexterops")
...
if __name__ == '__main__':
    try:
		...
		#dexter = Client("Dexter Courier","351.300.798.17","Logistica")
		#session.add(dexter)
		#backup = Product("Backup","Container de backup","backup")
		#session.add(backup)
		#servico = Service("23/07/2018","")
		#servico.product = backup
		#session.add(servico)
